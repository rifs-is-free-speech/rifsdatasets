...
class NSTDanishSpråkbanken(Base):
    ...
    def download(target_folder: str, verbose: bool = False, quiet: bool = False):
        ...
        with TemporaryDirectory() as tmpdirname:
            ...
            if not quiet:
                print(
                    """Warning: NSTDanishSråkbanken is a private dataset.
                You need to request access to the dataset from the authors.
                When you have downloaded the data, then place it in the audio
